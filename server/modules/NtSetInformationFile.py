...
DESCRIPTION = "Set information for an existing file handle (e.g., delete/rename)"
PARAMS = [
    {"name":"file_handle", "description":"Handle to the file", "type":"hex"},
...
def setFileInfo(agent_id, file_handle, info_class, info_data):
    from services.orders import write_scratchpad, send_and_wait
    
    data, shellcode = NtSetInformationFile(agent_id, file_handle, info_class, info_data)
...
def function(agent_id, args):
    ...
    retval = setFileInfo(agent_id, file_handle, info_class, info_data)
